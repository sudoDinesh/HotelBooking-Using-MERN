...
export default function PlacePage() {
        ...
        <div className="bg-black p-8 grid gap-4">
          <div>
            ...
            <button
              ...
              className="fixed right-12 top-8  flex gap-1 py-2 px-4 rounded-2xl shadow shadow-black bg-black text-white"
            >
              <svg
  ...
  return (
    <div className="mt-4 bg-gray-100 -mx-8 px-8 pt-8">
      ...
      <div className="mt-8 mb-8 grid gap-16 grid-cols-1 md:grid-cols-[2fr_1fr]">
        <div>
          <div className="my-4">
